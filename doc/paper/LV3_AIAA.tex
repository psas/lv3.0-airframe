...
Nose cone could be better manufactured with a von karman shaped mandrel for layup. Keep in touch with Machine Sciences about this because it would be a very generous donation to PSAS. Developing a similar build process to the modules. 
Further development and testing into the surface finish on the modules. 
\section{Conclusions}
