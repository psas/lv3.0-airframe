...
The \nomenclature{PSAS}{Portland State Aerospace Society} is an interdisciplinary group of engineering students and alumni of Portland State University (PSU) with the long term goal of putting a cubesat into orbit with their own rocket. 
...
% ^^^^^^ I went to the Boeing site to figure out whether they required a TM/C/R label and saw nothing. They only require these trademarking symbols for their text and icon. 
% Joe: I cannot think of anything else to add to this section after editing it. 
% Leslie: That's OK. If there's nothing to add, that's not a bad thing. I'm going to try and integrate this into the materials section anyways. --Joe
% Actually, I'm just going to comment this section out, since the same information is already in the above paragraphs.
...
% I tried to condense what was here into the above paragraphs. I'm commenting this stuff out, just in case there's stuff I missed.
