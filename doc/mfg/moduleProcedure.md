...
----------------------------
This is the procedure to make a cylindrical module. If you find any steps which are unclear, erroneous, unnecessary, or need improvement, please add an issue for it on this repo. 
...
1. Vacuum bag sheets
1. Vacuum bagging tape
1. Vacuum bagging breather material
1. Vacuum pump (of some sort)
1. Air hose
...
1. While one person moderately presses down on the template, another person should cut along the edges with a utility knife. It also works well to place weights on the templates while cutting.
...
![mandrel wrapped in release tape](../img/mandrelReleaseFilm.jpg)
...
![The first layer of carbon fiber added to the layup](../img/placeHolder.jpg)
...
![layup wrapped in final layer of release tapeand ready to be vacuum bagged.](../img/placeHolder.jpg)
...
![Final carbon fiber rocket module](../img/placeHolder.jpg)
